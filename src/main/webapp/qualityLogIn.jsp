...
<h1 id="titleOfPage">LOGIN FOR QUALITY REPORT</h1>
...
<input type="hidden" id ="status" value="<%=request.getAttribute("status") %>">
			...
			<div class="container">
				<div class="signin-content">
					...
					<div class="signin-form">
						...
						<form method="post" action="qualityLogin" class="register-form"
							id="login-form">
	...
	<script type="text/javascript">
		...
		if(status== "failed"){
			swal("Sorry, Only Quality Team Can Access!","Wrong username or password","error");
		}	
	</script>
