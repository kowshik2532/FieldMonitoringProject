...
<head>
    ...
    <title>Lat/Long Project Select</title>
...
<body>
	...
	<div class="topnav">
     ...
     try {		 
    	 	...
    	 	String webPage="Lat/Long Report";
    ...
    <div class="container">
        <form action="latLongPage.jsp" method="post">
...
<script>
function myFunction() {
  document.getElementById("desc").innerHTML = "Processing...";
  var demo1=document.getElementById("demo").innerHTML = "Please wait for 20-30 sec. ";
