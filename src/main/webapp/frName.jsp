...
<body>
	...
	<div class="container">	
        <form action="allDbConn.jsp" method="post">
            <label for="allFrName">Check All FR's Live Hourly Count:</label>   		
   ...
   <div class="container">
        ...
        <form action="dateWiseReport.jsp" method="post">
            <label for="dateWise">Date Wise All FR's Hourly Report </label>
