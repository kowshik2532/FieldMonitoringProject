...
%> 	
    ...
    %>
	  ...
	  <div class="headerDate">
   		 <label for="date">DATE : <%=editedDate%></label>
  	 </div>
	...
	<div class="container">	
        <form action="sampling.jsp" method="post">
            <label for="allFrName">All FR WISE</label>   		
			
          <% session.setAttribute("myList",arr);%>
           
           <input type="hidden" id="valueId" name="inputDate" value="<%=date%>">   
            <input type="hidden" id="valueProject" name="project" value="<%=prjName%>" >        
   ...
   <div class="container">
        ...
        <form action="teamWiseSampling.jsp" method="post">
            <label for="frName">TEAM WISE(SELECT A FR NAME):</label>
