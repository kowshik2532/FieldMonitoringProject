...
<body>
	...
	<div class="topnav">
     ...
     <!-- for fetching project name from local dataBase-->
     <%
	// Connection con=null;	
   ...
   //  HashSet<String> ProjectName=new HashSet<>();
	...
	//	}
     ...
     try {
        ...
        PreparedStatement ps=con.prepareStatement("select Project_Name from quality");
    ...
    <div class="container">
      <!--   <form action="qualityReportView.jsp" method="post"> --> 
      <form action="qualityAllProjectView.jsp" method="post">
